...
public class Controlador_FRM_MantenimientoUsuarios implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e)
  {
     ...
     {
         System.out.println("1 "+fuenteUsuario);
         
         if(fuenteUsuario.equals("Archivos")){
             System.err.println("ENTRO AL IF ARC"+fuenteUsuario);
         buscar();
         }
         ...
         if(fuenteUsuario.equals("BD"))
         {
            ...
            {
              mantenimientoUsuarios.mostrarInformacion(conexion.getArregloInformacion());
